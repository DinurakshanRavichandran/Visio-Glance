...
export const routes: Routes = [
  ...
  { path: 'system', component: SystemComponent, title: 'System'},
  ...
  { path: 'oct', component: OctAnalyserComponent, title:'Oct'},
  { path: 'sidebar', component: SidebarComponent, title: 'Sidebar'},
  { path: 'symptoms', component:SymptomsAnalyserComponent, title: 'Symptoms'},
