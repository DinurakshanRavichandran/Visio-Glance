...
var MatDrawer = class _MatDrawer {
  ...
  _animationStarted = new import_rxjs6.Subject();
  /** Emits whenever the drawer is done animating. */
  _animationEnd = new import_rxjs6.Subject();
  ...
  openedStart = this._animationStarted.pipe((0, import_operators5.filter)(() => this.opened), (0, import_operators5.mapTo)(void 0));
  /** Event emitted when the drawer has been closed. */
  _closedStream = this.openedChange.pipe((0, import_operators5.filter)((o) => !o), (0, import_operators5.map)(() => {
  }));
  /** Event emitted when the drawer has started closing. */
  closedStart = this._animationStarted.pipe((0, import_operators5.filter)(() => !this.opened), (0, import_operators5.mapTo)(void 0));
   ...
   */
  _modeChanged = new import_rxjs6.Subject();
  _injector = inject(Injector);
  _changeDetectorRef = inject(ChangeDetectorRef);
  constructor() {
    this.openedChange.pipe((0, import_operators5.takeUntil)(this._destroyed)).subscribe((opened) => {
      if (opened) {
        if (this._doc) {
    ...
    this._ngZone.runOutsideAngular(() => {
      const element = this._elementRef.nativeElement;
      (0, import_rxjs6.fromEvent)(element, "keydown").pipe((0, import_operators5.filter)((event) => {
        return event.keyCode === ESCAPE && !this.disableClose && !hasModifierKey(event);
      }), (0, import_operators5.takeUntil)(this._destroyed)).subscribe((event) => this._ngZone.run(() => {
        this.close();
  ...
  _setOpen(isOpen, restoreFocus, focusOrigin) {
    ...
    this._updateFocusTrapState();
    return new Promise((resolve) => {
      this.openedChange.pipe((0, import_operators5.take)(1)).subscribe((open) => resolve(open ? "open" : "close"));
    });
  }
...
var MatDrawerContainer = class _MatDrawerContainer {
  ...
  _doCheckSubject = new import_rxjs6.Subject();
  /**
  ...
  _contentMarginChanges = new import_rxjs6.Subject();
  ...
  constructor() {
    ...
    viewportRuler.change().pipe((0, import_operators5.takeUntil)(this._destroyed)).subscribe(() => this.updateContentMargins());
  ...
  ngAfterContentInit() {
    this._allDrawers.changes.pipe((0, import_operators5.startWith)(this._allDrawers), (0, import_operators5.takeUntil)(this._destroyed)).subscribe((drawer) => {
      this._drawers.reset(drawer.filter((item) => !item._container || item._container === this));
      this._drawers.notifyOnChanges();
    });
    this._drawers.changes.pipe((0, import_operators5.startWith)(null)).subscribe(() => {
      this._validateDrawers();
    ...
    this._ngZone.runOutsideAngular(() => {
      this._doCheckSubject.pipe(
        (0, import_operators5.debounceTime)(10),
  ...
  _watchDrawerToggle(drawer) {
    drawer._animationStarted.pipe((0, import_operators5.takeUntil)(this._drawers.changes)).subscribe(() => {
      this.updateContentMargins();
      this._changeDetectorRef.markForCheck();
    });
    if (drawer.mode !== "side") {
      drawer.openedChange.pipe((0, import_operators5.takeUntil)(this._drawers.changes)).subscribe(() => this._setContainerClass(drawer.opened));
    }
  }
  /**
  ...
  _watchDrawerPosition(drawer) {
    drawer.onPositionChanged.pipe((0, import_operators5.takeUntil)(this._drawers.changes)).subscribe(() => {
      afterNextRender({
  ...
  _watchDrawerMode(drawer) {
    drawer._modeChanged.pipe((0, import_operators5.takeUntil)((0, import_rxjs6.merge)(this._drawers.changes, this._destroyed))).subscribe(() => {
      this.updateContentMargins();
      this._changeDetectorRef.markForCheck();
    });
  }
